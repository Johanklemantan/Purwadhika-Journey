...
def category_plot(
    ...
    if cat_plot == 'histplot':
        layout = go.Layout(
            ...
            #boxmode group berfungsi untuk mengelompokkan box berdasarkan hue nya
            boxmode='group'
        )
    else:
        layout = go.Layout(
...
def home():
    ...
    return render_template(
        ...
        # untuk sumbu Y tidak ada, karena nantinya menu dropdown Y akan di disable
...
def cat_fn(nav):
    ...
    #ketika dari boxplot ke histogram akan none
    if estimator == None:
        estimator='count'
